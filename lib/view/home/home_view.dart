...
import 'package:riyada_gym/common_widget/workout_row.dart';
...
// this class is used to create the home view of the app which is the first screen that the user sees after logging in
...
class _HomeViewState extends State<HomeView> {
  ...
  // this List is used to create the graph that shows the water intake of the user
  ...
  // this Widget is used to create the graph that shows the water intake of the user in the home view
  @override
  Widget build(BuildContext context) {
    ...
    // Scaffold is used to create the basic structure of the page to be displayed on the screen
    return Scaffold(
